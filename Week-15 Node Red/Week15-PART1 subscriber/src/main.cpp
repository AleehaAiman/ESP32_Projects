/***************************************************
 * Aleeha Aiman              23-NTU-CS-1243
 * WEEK15-PART1-Subscriber
 * BSCS-5A
 *
 * ESP32 + MQTT Subscriber + OLED (Temp only) +NodeRed
...
// ---------- MQTT ----------
const char *mqtt_server = "10.13.71.198"; // Change to your MQTT broker IP
